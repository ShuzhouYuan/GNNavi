...
This repository contains the code for the paper [*GNNavi: Navigating the Information Flow in Large Language Models by Graph Neural Network*](https://aclanthology.org/2024.findings-acl.237.pdf).
