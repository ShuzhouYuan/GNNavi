...
class ICLforClassification(LightningModule):
    def __init__(
        ...
        self.label_map = {tokenizer.encode(v, add_special_tokens=False)[1]: k for k, v in
...
def main(args):
    ...
    icldata = ICLDataModule(args.task_name, args.num_test, args.num_demo_per_class, args.batch_size, tokenizer, model_max_length=4096)
