...
class LlamaForCausalLMwithGNN(LlamaForCausalLM):
    _tied_weights_keys = ["lm_head.weight"]

    def __init__(self, config):
        super().__init__(config)
        self.model = LlamawithGNN(config)
    ...
    def forward(
        ...
        outputs = self.model(
            ...
            edge_index_first = edge_index_first,
            edge_index_last = edge_index_last,
        )
